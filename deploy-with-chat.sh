#!/bin/bash
# Deploy Expense Management System to Azure with GenAI Services
# This script deploys everything including Azure OpenAI and AI Search for chat functionality

set -e

echo "============================================"
echo "Expense Management System - Full Deployment"
echo "(Including GenAI Services)"
echo "============================================"
...
echo ""
echo "Step 2: Deploying infrastructure (App Service, Managed Identity, SQL Server, Azure OpenAI, AI Search)..."
...
echo "✓ App Service configured with OpenAI and Search settings"
...
echo ""
echo "The Chat UI is now enabled with Azure OpenAI!"
echo ""
echo "To run locally:"
echo "1. Update appsettings.json with the connection strings and OpenAI settings"
